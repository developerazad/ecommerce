                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($products as $key => $row)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" data-toggle="modal" data-action="{{ url('products/'.$row->product_id.'/edit') }}" data-modal="{{ $header['modalSize'] }}" data-title="Edit {{ $row->product_name }}" data-target="#myModal" class="btn btn-info btn-xs modal-link">Edit</button> |
